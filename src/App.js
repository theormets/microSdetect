...
const ModelProtectedRoute = ({ children }) => {
    // TODO(Amitkumar): status check using redux : Done
    const navigate = useNavigate();
    const { user } = useSelector(
        (state) => state.userReducer,
        shallowEqual
